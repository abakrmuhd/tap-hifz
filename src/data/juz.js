export const JUZ_RANGES = [
  ...
  [6, 102, 120], [7, 121, 141], [8, 142, 161], [9, 162, 181], [10, 182, 200],
  [11, 201, 221], [12, 222, 241], [13, 242, 261], [14, 262, 281], [15, 282, 301],
...
export function getJuzForPage(page) {
  return JUZ_RANGES.find(([, start, end]) => page >= start && page <= end) ?? JUZ_RANGES[0];
}
